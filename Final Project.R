...
# Basic Scatter plot Matrix of numerical data
# pairs(~BMI + PhysicalHealth + MentalHealth + SleepTime, data = heart_data,
#      main = "Basic Scatter plot Matrix by Heart Diease/No Heart Disease")

# Colored Scatter Plot by Heart Diease/No Heart Disease
# group <- NA
# group[heart_data$HeartDisease == 'Yes'] <- 1
# group[heart_data$HeartDisease == 'No'] <- 2

# pairs(~BMI + PhysicalHealth + MentalHealth + SleepTime,
#        data = heart_data,
#        col = c("red", "green")[group],
#       main = "Colored Scatter Plot by Heart Diease/No Heart Disease")
...
train <- final_data[ train.index,]
test <- final_data[-train.index,]
...
confusionMatrix(rf,train$HeartDisease)
